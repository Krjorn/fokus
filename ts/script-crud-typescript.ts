...
const deleteTask = (state: ApplicationState, deleteType: DeleteType): ApplicationState => {
...
const updateUI = () => {
    ...
    const btnDeleteFinished = document.querySelector<HTMLButtonElement>('#btn-remover-concluidas')
    const btnDeleteAll = document.querySelector<HTMLButtonElement>('#btn-remover-todas');
    const ulTasks = document.querySelector<HTMLUListElement>('.app__section-task-list');
    const formAddTask = document.querySelector<HTMLFormElement>('.app__form-add-task');
    const formLabel = document.querySelector('.app__form-label');
    const textarea = document.querySelector<HTMLTextAreaElement>('.app__form-textarea');
    const btnDeleteSelected = document.querySelector<HTMLButtonElement>('.app__form-footer__button--delete');
    const btnCancelForm = document.querySelector<HTMLButtonElement>('.app__form-footer__button--cancel');
